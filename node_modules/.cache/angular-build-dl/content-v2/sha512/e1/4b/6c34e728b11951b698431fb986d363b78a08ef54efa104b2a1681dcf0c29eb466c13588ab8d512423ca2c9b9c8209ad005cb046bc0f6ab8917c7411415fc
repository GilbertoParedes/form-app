...
const routes = [
    ...
    {
        path: 'list-user',
        loadChildren: () => __webpack_require__.e(/*! import() | list-user-list-user-module */ "common").then(__webpack_require__.bind(null, /*! ./list-user/list-user.module */ "./src/app/pages/user/list-user/list-user.module.ts")).then(m => m.ListUserPageModule)
    }
];
