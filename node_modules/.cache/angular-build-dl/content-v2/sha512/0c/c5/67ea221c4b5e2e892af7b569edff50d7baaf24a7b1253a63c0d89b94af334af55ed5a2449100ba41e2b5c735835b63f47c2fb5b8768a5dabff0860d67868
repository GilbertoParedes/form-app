...
const routes = [
    ...
    {
        path: 'list-user',
        loadChildren: () => __webpack_require__.e(/*! import() | list-user-list-user-module */ "default~list-user-list-user-module~pages-user-list-user-list-user-module").then(__webpack_require__.bind(null, /*! ./list-user/list-user.module */ "./src/app/pages/user/list-user/list-user.module.ts")).then(m => m.ListUserPageModule)
    },
    {
        path: 'update',
        loadChildren: () => __webpack_require__.e(/*! import() | update-update-module */ "update-update-module").then(__webpack_require__.bind(null, /*! ./update/update.module */ "./src/app/pages/user/update/update.module.ts")).then(m => m.UpdatePageModule)
    }
];
