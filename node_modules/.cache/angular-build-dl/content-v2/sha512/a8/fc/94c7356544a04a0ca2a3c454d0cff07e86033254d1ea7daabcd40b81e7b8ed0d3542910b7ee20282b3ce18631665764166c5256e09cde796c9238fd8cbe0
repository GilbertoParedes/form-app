...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesAfiliadoServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AfiliadoService", function () {
    ...
    var AfiliadoService = /*#__PURE__*/function () {
      ...
      _createClass(AfiliadoService, [{
        ...
        value: function register(form) {
          ...
          this.token = this.storage.getItem('token').then(function (token) {
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
              ...
              'Authorization': _this3.token["token_type"] + " " + _this3.token["access_token"]
            });
            return _this3.http.post(_this3.env.API_URL + 'api/auth/afiliados', {
              name: form['name'],
              ...
              cant_menores: form['cant_menores'],
              cant_mayores: form['cant_mayores'],
              cant_viviendo: form['cant_viviendo'],
        ...
        key: "afiliados",
        value: function afiliados() {
          var _this4 = this;

          return rxjs__WEBPACK_IMPORTED_MODULE_6__["Observable"].fromPromise(this.storage.getItem('token')).flatMap(function (token) {
            _this4.token = token;
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({
              'Accept': 'application/json, text/plain',
              'Content-Type': 'application/json',
              'Authorization': _this4.token["token_type"] + " " + _this4.token["access_token"]
            });
            return _this4.http.get(_this4.env.API_URL + 'api/auth/afiliados', {
              headers: headers
            }); // .pipe(
            //   tap(afili => {
            //     return afili;
    ...
    AfiliadoService.ctorParameters = function () {
      return [{
    ...
    AfiliadoService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], AfiliadoService); //   afiliados(){
